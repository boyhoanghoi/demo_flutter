...
CORS_ALLOW_ALL_ORIGINS = True #Set to False in production after configuring allowed origins
CORS_ALLOW_CREDENTIALS = True # Keep if using token authentication
...
SECURE_REFERRER_POLICY = "strict-origin-when-cross-origin" # Helps protect against CSRF
